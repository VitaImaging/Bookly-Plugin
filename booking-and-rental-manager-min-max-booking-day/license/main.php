...
add_action('rbfw_license_page_addon_list', 'rbfw_pro_mmbd_licensing');
function rbfw_pro_mmbd_licensing()
{
    $key_option_name        = 'rbfw_pro_mmbd_license_key';
    $status_option_name     = 'rbfw_pro_mmbd_license_status';
    $expire_option_name     = 'rbfw_pro_mmbd_license_expire';
    $order_id_option_name   = 'rbfw_pro_mmbd_license_order_id';
    $active_btn_id          = 'rbfw_pro_mmbd_active';
    $deactive_btn_id        = 'rbfw_pro_mmbd_deactive';
    $license                = get_option($key_option_name);
    $status                 = get_option($status_option_name);
?>
    <tr>
        <td><?php _e(RBFW_PRO_MMBD_NAME, 'mage-eventpress-waitlist'); ?></td>
                        ...
                        if (key) {
                            jQuery.ajax({
                                ...
                                data: {
                                    ...
                                    "item_name"             : '<?php echo RBFW_PRO_MMBD_NAME; ?>',
                                    "item_id"               : '<?php echo RBFW_PRO_MMBD_ID; ?>',
                                    "key"                   : key
                                },
                                beforeSend: function() {
